...
The distance, $d$, between the company's CO2 emissions intensity per unit production at a given base year,  $I^{Co}(t_0)$, and the target average market intensity in 2050, $I^{in}(t_{2050})$ is calculated. The target intensity in 2050 is taken from a climate scenario:
