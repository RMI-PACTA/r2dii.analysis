...
How can you allocate [scenario efforts] to the production profile of your portfolio? You can do it by technology or by sector.
...
* Create a "master" dataset: Joining the `matched` dataset to three other datasets:
    ...
    2. A dataset giving the production-targets `scenario`;
    3. A dataset mapping countries to scenario-defined `regions`.
