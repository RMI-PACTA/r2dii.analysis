...
The target functions of this package bundle many operations together to allow 
ease of use. However, you may also find the following utility functions useful:
